<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- BUNGKUS LINK ADMIN DI DALAM KONDISI INI --}}
                    @if (Auth::user()->role == 'admin')
                        ...
                        <x-nav-link :href="route('reports.performance')" :active="request()->routeIs('reports.performance')">
                            {{ __('Laporan') }}
                        </x-nav-link>
                    @endif
                </div>
            ...
            {{-- ... sisa file (menu dropdown, dll) tetap sama ... --}}
            <!-- Settings Dropdown -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- BUNGKUS JUGA LINK ADMIN UNTUK TAMPILAN MOBILE --}}
             @if (Auth::user()->role == 'admin')
